...
class ApprovedRevs {
	 ...
	 *     titles based upon page props set by parser function #set_approvers.
	...
	public static function userCanApprove( User $user, Title $title ) {
		...
		if ( self::$mUserCanApprove ) {
			...
			// permission, nor does #set_approvers grant them
	 ...
	 *
	 * @param User $user Check if this user has #set_approvers permissions on title
